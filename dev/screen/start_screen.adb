...
S:Lstart_screen.screen_start_screen_update$screen_type$1_0$17({2}DG,SC:U),B,1,4
S:Lstart_screen.screen_start_screen_update$input$1_0$18({1}SC:U),B,1,-1
S:Lstart_screen.screen_start_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
S:Fstart_screen$timer$0_0$0({1}SC:U),E,0,0
